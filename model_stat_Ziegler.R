...
good_all<-function(xmonod, xmend, xpirt, xdeb){
  ...
  stat_eachF<-data.frame(Variable=c("CO2", "PLFA", "G"),
  ...
  stat_eachLR<-data.frame(Variable=c("CO2", "PLFA", "G"),
...
Ziegler_fit$Gfit
Ziegler_fit$stat_eachF
Ziegler_fit$stat_eachLR
Ziegler_fit$stat_allF
Ziegler_fit$stat_allLR
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Figure~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
