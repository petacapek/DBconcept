...
good_all<-function(xmonod, xmend, xpirt, xdeb){
  ...
  stat_eachF<-data.frame(Variable=c("CO2", "CFC14", "G"),
  ...
  stat_eachLR<-data.frame(Variable=c("CO2", "CFC14", "G"),
...
Hasan_fit$Gfit
Hasan_fit$stat_eachF
Hasan_fit$stat_eachLR
Hasan_fit$stat_allF
Hasan_fit$stat_allLR
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Figure~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
